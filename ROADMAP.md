# EduVerse Malaysia — Engagement Roadmap

Goal: every session ends with the kid wanting one more quest. Ordered by
impact-per-effort; each item is shippable on its own.
...
- [x] **4. Chapter quests / story mode** *(shipped 2026-07-11 — torn map, 9 lore beats, legendary finale item)* — a light narrative thread: Sang
      ...
      a reason to exist beyond "school topics".*
